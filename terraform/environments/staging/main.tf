...
resource "aws_eks_node_group" "main" {
  ...
  scaling_config {
    desired_size = var.node_groups["main"].scaling_config.desired_size
    max_size     = var.node_groups["main"].scaling_config.max_size
    min_size     = var.node_groups["main"].scaling_config.min_size
  }
